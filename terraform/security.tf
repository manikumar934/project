...
# Frontend ECS Security Group - accepts traffic from ALB only
...
# Backend ECS Security Group - accepts traffic from frontend only
...
# RDS Security Group - accepts MySQL from backend only
